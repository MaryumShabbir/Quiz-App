// Starter.jsx
import { Text, SafeAreaView, View, Image, Dimensions, ImageBackground  } from "react-native";
...
const Starter = () => {
  const { numQuestions, questionType, updateNumQuestions, updateQuestionType } = useQuizContext();
  ...
  return (
    ...
    <SafeAreaView style={styles.container}>
      {userName && <Text style={styles.userNameStyle}>Hello, {userName}</Text>}
      	...
      	<View style={styles.innerContainer}>
      				<MaskedView
      					...
      					maskElement={
      						...
      						>
      							<Text style={styles.titleText}>IQOSITY</Text>
      						</View>
      					}
      				>
      				...
      				<View style={styles.outerOptionsContainer}>
      					...
      					<View style={styles.optionsContainer}>
      						<View style={styles.questionType}>
      							 <Text style={[styles.subtitle, { color: 'white', fontWeight: 'bold' }]}>
